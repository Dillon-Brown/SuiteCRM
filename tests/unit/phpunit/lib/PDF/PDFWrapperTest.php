...
namespace SuiteCRM\Tests\Unit\lib\PDF;
 ...
 * @covers PDFWrapper
 */
class PDFWrapperTest extends SuitePHPUnitFrameworkTestCase
{
    ...
    {
        PDFWrapper::addEngine('TestPDFEngine', 'TestPDFEngine.php', 'TestPDFEngine');
        $engines = PDFWrapper::getEngines();
