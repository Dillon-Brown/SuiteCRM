...
class ElasticSearchIndexerTest extends SearchTestAbstract
{
    ...
    public function testRemoveBeans(): void
    {
        ...
        $mock->shouldReceive('bulk')->once()->withAnyArgs($params);
    ...
    public function testRemoveIndex(): void
    {
        ...
        $mockIndices
            ->shouldReceive('delete')
            ->once()
            ->withAnyArgs(['index' => $sugar_config['unique_key'], 'client' => ['ignore' => [404]]]);
    ...
    public function testRemoveIndex2(): void
    {
        ...
        $mockIndices
            ->shouldReceive('delete')
            ->once()
            ->withAnyArgs(['index' => $index, 'client' => ['ignore' => [404]]]);
