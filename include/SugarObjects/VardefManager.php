...
class VardefManager
{
    ...
    static function addTemplate($module, $object, $template, $object_name = false)
    {
        ...
        if (!empty($templates[$template])) {
            ...
            $GLOBALS['dictionary'][$object]['fields'] = array_merge($templates[$template]['fields'],
                $GLOBALS['dictionary'][$object]['fields']);
            if (!empty($templates[$template]['relationships'])) {
                $GLOBALS['dictionary'][$object]['relationships'] = array_merge($templates[$template]['relationships'],
                    $GLOBALS['dictionary'][$object]['relationships']);
            }
            if (!empty($templates[$template]['indices'])) {
                $GLOBALS['dictionary'][$object]['indices'] = array_merge($templates[$template]['indices'],
     ...
     */
    static function refreshVardefs(
        $module,
        $object,
