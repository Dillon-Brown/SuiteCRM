...
class SugarTheme
{
    ...
    public function getCSS(
        ...
        if (!empty($this->colors)) {
            if (isset($_SESSION['authenticated_user_theme_color']) && in_array($_SESSION['authenticated_user_theme_color'],
                    $this->colors)
            ) {
        ...
        if (!empty($this->fonts)) {
            if (isset($_SESSION['authenticated_user_theme_font']) && in_array($_SESSION['authenticated_user_theme_font'],
                    $this->fonts)
            ) {
