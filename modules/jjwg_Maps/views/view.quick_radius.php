    ...
    <tr>
        ...
        <td>
            <input type="text" name="quick_address" id="quick_address"
                   value="<?php echo htmlspecialchars($_REQUEST['quick_address'], ENT_QUOTES | ENT_HTML5); ?>" title='' tabindex='101' size="40" maxlength="255">
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            ...
            ?>
                    <option value="<?php echo htmlspecialchars($module, ENT_QUOTES | ENT_HTML5); ?>" <?php
    ...
    <tr>
        ...
        <td>
            <input type="text" name="distance" id="distance"
                   value="<?php echo htmlspecialchars($_REQUEST['distance'], ENT_QUOTES | ENT_HTML5); ?>" title='' tabindex='121' size="10" maxlength="10">
