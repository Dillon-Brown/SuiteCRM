...
html;
    ...
    public function save($check_notify = false)
    {
        ...
        $this->mail_smtppass = $this->mail_smtppass ? blowfishEncode(blowfishGetKey('OutBoundEmail'),
            $this->mail_smtppass) : null;
    ...
    public function retrieve($id = -1, $encode = true, $deleted = true)
    {
        ...
        $this->mail_smtppass = $this->mail_smtppass ? blowfishDecode(blowfishGetKey('OutBoundEmail'),
            $this->mail_smtppass) : null;
