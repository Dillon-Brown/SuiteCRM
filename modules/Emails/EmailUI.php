...
class EmailUI
{
    ...
    function displayEmailFrame($baseTpl = "modules/Emails/templates/_baseEmail.tpl")
    {
        ...
        $this->smarty->assign('signaturesSettings',
            $current_user->getSignatures(false, $defsigID, false, 'signature_id'));
        $this->smarty->assign('signaturesAccountSettings',
            $current_user->getEmailAccountSignatures(false, $defsigID, false, 'account_signature_id'));
