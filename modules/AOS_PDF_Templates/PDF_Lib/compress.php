...
echo '<div>mPDF file size '.\number_format((\strlen($x)/1024)).' kB</div>';
...
echo '<div>Memory usage on loading mPDF class '.\number_format((\memory_get_usage(true)/(1024*1024)),2).' MB</div>';
