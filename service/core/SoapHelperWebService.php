...
class SoapHelperWebServices
{
    ...
    {
        LoggerManager::getLogger()->info('Begin: SoapHelperWebServices->get_field_list(' . print_r(
            $value,
            true
    ...
    public function get_name_value_list_for_fields($value, $fields)
    {
        ...
        if ($this->isLogLevelDebug()) {
            LoggerManager::getLogger()->debug('SoapHelperWebServices->get_name_value_list_for_fields - return data = ' . var_export(
                $list,
                true
            ));
        } // if
    ...
    public function get_return_value_for_link_fields($bean, $module, $link_name_to_value_fields_array)
    {
        ...
        if ($this->isLogLevelDebug()) {
            LoggerManager::getLogger()->debug('SoapHelperWebServices->get_return_value_for_link_fields - link info = ' . var_export(
        ...
        if ($this->isLogLevelDebug()) {
            LoggerManager::getLogger()->debug('SoapHelperWebServices->get_return_value_for_link_fields - output = ' . var_export(
                $link_output,
                true
            ));
        } // if
